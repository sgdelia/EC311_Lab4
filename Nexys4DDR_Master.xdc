...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { position[0] }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { position[1] }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
...
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { testLED1 }]; #IO_L18P_T2_A24_15 Sch=led[0]
#set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { testLED2 }]; #IO_L24P_T3_RS1_15 Sch=led[1]
...
#set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { mode_bttn}]; #IO_L12P_T1_MRCC_14 Sch=btnl
